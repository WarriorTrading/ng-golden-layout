...
export declare class GoldenLayoutComponent implements OnInit, OnDestroy, ComponentInitCallbackFactory {
    ...
    private unloaded;
    private el;
    constructor(glService: GoldenLayoutService, viewContainer: ViewContainerRef, appref: ApplicationRef, componentFactoryResolver: ComponentFactoryResolver, ngZone: NgZone, injector: Injector);
    ngOnInit(): void;
    ngOnDestroy(): void;
    unloadHandler(): void;
